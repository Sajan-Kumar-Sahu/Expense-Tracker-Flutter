...
abstract class CategoryRemoteDataSource {
  Future<List<CategoryResponse>> getCategories(String userId);
...
class CategoryRemoteDataSourceImpl
  ...
  Future<List<CategoryResponse>> getCategories(
    ...
    final response = await apiClient.get(
      '${ApiEndpoints.categories}/user/$userId',
    );

    return (response.data['data'] as List<dynamic>)
        .map((json) => CategoryResponse.fromJson(
  ...
  Future<CategoryResponse> updateCategory(
    ...
    return CategoryResponse.fromJson(response.data!['data'] as Map<String, dynamic>);
  }
