...
class _AccountDetailsPageState extends ConsumerState<AccountDetailsPage> {
          ...
          SliverAppBar(
            ...
            actions: [
              _CircleIconButton(
                ...
                onTap: () => context.push(AppRouter.editAccount, extra: account),
              ),
              SizedBox(width: 6.w),
              _CircleIconButton(
              ...
              background: Container(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(_typeIcon(account.accountType),
                              size: 12.sp, color: typeColor),
                          SizedBox(width: 4.w),
                          Text(
                            _typeText(account.accountType),
                            style: TextStyle(
                              fontSize: 12.sp,
                    ...
                    SizedBox(height: 6.h),
                    Text(
                      '${account.name}  ·  Opening: ₹${account.openingBalance.toStringAsFixed(2)}',
                      style: TextStyle(
                        fontSize: 13.sp,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: _StatChip(
                          label: 'Type',
                          value: _typeText(account.accountType),
                          iconData: _typeIcon(account.accountType),
                      ...
                      Expanded(
                        child: _StatChip(
                          ...
                          iconData: account.isActive
                              ? Icons.check_circle_outline_rounded
                              : Icons.cancel_outlined,
                          iconBg: account.isActive
                              ? const Color(0xFFE1F5EE)
                              : const Color(0xFFFCEBEB),
                          iconColor: account.isActive
                  ...
                  if (account.description != null &&
                    ...
                    SizedBox(height: 10.h),
                    _NotesCard(notes: account.description!),
                  ],
  ...
  Future<void> _confirmDelete(BuildContext context) async {
    ...
    final success =
        await ref.read(accountsProvider).deleteAccount(widget.account.id);
